...
async def callback_router(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if data.startswith('bbuilder_'):
        await bonus_builder.bonus_builder_callback_handler(update, context)
    elif data.startswith(('brochure_', 'folheteria_')):
    ...
    # --- Roteamento para Módulos Não Refatorados ---
        ...
        await query.answer("Este botão parece estar desatualizado.", show_alert=True)