...
def register_command_handlers(application: Application) -> None:
    ...
    command_handlers = {
        "start": start.start, "ajuda": help.ajuda, "admin_listar": listar_admins,
        "admin_silenciar": silenciar, "admin_banir": banir, "admin_desbanir": desbanir,
        "admin_fixar": fixar, "admin_desfixar": desfixar, "admin_enviar": enviartextocanal,
        "produtos": product_handlers.beneficiosprodutos, "bonusconstrutor": bonus_builder.bonus_construtor,
        "regras": rules.mostrar_regras, "marketingrede": marketing.marketing_rede,
        "recompensas2024": rewards.recompensas2024, "planificacao": planning.enviar_planificacao,
        "seguimento": kits.seguimento, "apresentacao": opportunity.apresentacaooportunidade,
        ...
        "convite": invites.mostrar_convites, "artes": art_creator.artes,
        "treinamento": training.treinamento, "ranking": ranking.mostrar_ranking,
        "leitura": reading_guide.leitura, "canais": channels.canais,
        "fidelidade": loyalty.fidelidade, "tabelas": tables.tabelas_menu,
        "usage_top": send_top_users_command, "usage_reset": reset_usage_data_command,
    }
